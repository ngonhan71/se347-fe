        ...
        <Container>
          <div className="d-flex">
              <div className={styles.headerTopLeft}>
                <p>Chào mừng bạn đến với <span className={styles.shophoaHighlight}>Shop Hoa</span></p>
                {currentUser && currentUser.role > 0 
                && <Link to="/admin" className={`ms-4 ${styles.navigateAdmin}`}>Quản lý Shop Hoa</Link>}
              </div>
              <div className={styles.headerTopRight}>
                <p className={styles.hotline}>Hotline: <span className={styles.shophoaHighlight}>08 111 222</span></p>
                <p className="bookstore-email d-flex align-items-center">
                  <IoMailOutline style={{marginRight: 5}}/> shophoa@gmail.com
                </p>
              </div>
          </div>
        </Container>
